...
#Original - for use in real time validation
...
if __name__ == '__main__':
    ...
    validation_df = Train[LINE_SEP_LOWER_THEN_2017_07_16::]
    stores = test_df.store_nbr.unique()
    families = test_df.family.unique()
    ...
    if with_cached_model_metadata == 'True':
        ...
        for store in stores:
            is_store_nbr = test_df['store_nbr'] == store
            Filtered_df = test_df[is_store_nbr].copy()
